...
@Component({
  selector: 'app-gate-out-pass-retrieve',
  standalone: true,
  imports: [SharedModule, FormsModule,],
  templateUrl: './gate-out-pass-retrieve.component.html', 
  styleUrl: './gate-out-pass-retrieve.component.scss',
  animations: [
    trigger('fadeIn', [
      transition(':enter', [
        style({ opacity: 0 }),
...
export class GateOutPassRetrieveOutwardComponent implements OnInit {
