...
@Component({
  selector: 'app-gate-out-pass',
  standalone: true,
  imports: [SharedModule, FormsModule,],
  templateUrl: './gate-out-pass.component.html',
  styleUrls: ['./gate-out-pass.component.scss'],
  animations: [
    trigger('fadeIn', [
      transition(':enter', [
        style({ opacity: 0 }),
...
export class GateOutPassOutwardComponent implements OnInit {
