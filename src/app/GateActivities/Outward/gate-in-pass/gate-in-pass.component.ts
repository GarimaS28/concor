...
@Component({
  selector: 'app-gate-in-pass',
  standalone: true,
  imports: [SharedModule, FormsModule,],
  templateUrl: './gate-in-pass.component.html',
  styleUrls: ['./gate-in-pass.component.scss'],
  animations: [
    trigger('fadeIn', [
      transition(':enter', [
        style({ opacity: 0 }),
...
export class GateInPassOutwardComponent implements OnInit {
