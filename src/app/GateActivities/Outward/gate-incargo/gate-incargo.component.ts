...
@Component({
  selector: 'app-gate-incargo',
  standalone: true,
  imports: [SharedModule, FormsModule,],
  templateUrl: './gate-incargo.component.html',
  styleUrls: ['./gate-incargo.component.scss'],
  animations: [
    trigger('fadeIn', [
      transition(':enter', [
        style({ opacity: 0 }),
...
export class GateINCargoComponent implements OnInit {
