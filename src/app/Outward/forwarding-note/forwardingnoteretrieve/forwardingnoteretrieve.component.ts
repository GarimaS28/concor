...
@Component({
  selector: 'app-forwardingnoteretrieve',
  standalone: true,
  imports: [SharedModule, FormsModule,],
  templateUrl: './forwardingnoteretrieve.component.html', 
  styleUrl: './forwardingnoteretrieve.component.scss',
  animations: [
    trigger('fadeIn', [
      transition(':enter', [
        style({ opacity: 0 }),
...
export class ForwardingnoteretrieveComponent implements OnInit {
