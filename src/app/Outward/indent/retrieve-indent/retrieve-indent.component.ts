...
@Component({
  selector: 'app-retrieve-indent',
  standalone: true,
  imports: [SharedModule, FormsModule,],
  templateUrl: './retrieve-indent.component.html', 
  styleUrl: './retrieve-indent.component.scss',
  animations: [
    trigger('fadeIn', [
      transition(':enter', [
        style({ opacity: 0 }),
...
export class RetrieveIndentComponent implements OnInit {
